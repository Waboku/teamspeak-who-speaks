function Font = BitmapFont(Name,Size,Characters,bold,Padding)
...
for i = 1:length(Characters)
    ...
    if(bold == 1)
        texthandle = text(0.5,1,Characters(i),'Units','Normalized','FontName',Name,'FontUnits','pixels','FontSize',Size,'HorizontalAlignment','Center','VerticalAlignment','Top','Interpreter','None','Color',[0 0 0],'FontSmoothing','off','FontWeight','bold');
    else
        texthandle = text(0.5,1,Characters(i),'Units','Normalized','FontName',Name,'FontUnits','pixels','FontSize',Size,'HorizontalAlignment','Center','VerticalAlignment','Top','Interpreter','None','Color',[0 0 0],'FontSmoothing','off');
    end
    drawnow;
    % Take a snapshot
    Bitmap = getframe(gcf);
