...
const keyboard_keys_t kb_lettersSmall =	{ .characters[0] = KB_LETTER_LO_C3, .characters[1] = KB_LETTER_LO_C2, .characters[2] = KB_LETTER_LO_C1, .characters[3] = KB_LETTER_LO_C0 , .keyPos[0] = KB_LETTER_POS_C3, .keyPos[1] = KB_LETTER_POS_C2, .keyPos[2] = KB_LETTER_POS_C1,  .keyPos[3] = KB_LETTER_POS_C0 };
const keyboard_keys_t kb_lettersBig	  =	{ .characters[0] = KB_LETTER_HI_C3, .characters[1] = KB_LETTER_HI_C2, .characters[2] = KB_LETTER_HI_C1, .characters[3] = KB_LETTER_HI_C0 , .keyPos[0] = KB_LETTER_POS_C3, .keyPos[1] = KB_LETTER_POS_C2, .keyPos[2] = KB_LETTER_POS_C1,  .keyPos[3] = KB_LETTER_POS_C0 };
const keyboard_keys_t kb_symbols	  =	{ .characters[0] = KB_SYMBOL_C3, .characters[1] = KB_SYMBOL_C2, .characters[2] = KB_SYMBOL_C1, .characters[3] = KB_SYMBOL_C0 , .keyPos[0] = KB_SYMBOL_POS_C3, .keyPos[1] = KB_SYMBOL_POS_C2, .keyPos[2] = KB_SYMBOL_POS_C1,  .keyPos[3] = KB_SYMBOL_POS_C0 };

const uint8_t kb_colCords[KB_TOTAL_COLOMS+1] = {KB_COL0_S+1, KB_COL1_S+1, KB_COL2_S+1, KB_COL3_S, KB_END+1};
...
*
*/
void keyboard_render(const keyboard_keys_t *kb){
